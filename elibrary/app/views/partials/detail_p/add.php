...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Detail Peminjaman</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="detail_p-add-form"  novalidate role="form" enctype="multipart/form-data" class="form multi-form page-form" action="<?php print_link("detail_p/add?csrf_token=$csrf_token") ?>" method="post" >
                            <div>
                                        ...
                                        <tr class="input-row">
                                            <td>
                                                <div id="ctrl-id_buku-row<?php echo $row; ?>-holder" class="">
                                                    <select required=""  id="ctrl-id_buku-row<?php echo $row; ?>" name="row<?php echo $row ?>[id_buku]"  placeholder="Select a value ..."    class="custom-select" >
                                            ...
                                            <td>
                                                <div id="ctrl-jum_pinjam-row<?php echo $row; ?>-holder" class="">
                                                    <input id="ctrl-jum_pinjam-row<?php echo $row; ?>"  value="<?php  echo $this->set_field_value('jum_pinjam',"", $row); ?>" type="number" placeholder="Jumlah Pinjam" step="1"  required="" name="row<?php echo $row ?>[jum_pinjam]"  class="form-control " />
                                                    </div>
                                                </td>
