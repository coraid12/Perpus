                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nim"  value="<?php  echo $data['nim']; ?>" type="text" placeholder="Tambahkan NIM" list="nim_list"  required="" name="nim"  class="form-control " />
