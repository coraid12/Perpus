...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Transaksi Pengembalian</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form id="pengembalian-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("pengembalian/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="nim">Nama <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-nim" name="nim"  placeholder="Select a value ..."    class="selectize" >
                                                    ...
                                                    <?php 
                                                    $nim_options = $comp_model -> pengembalian_nim_option_list();
                                                    if(!empty($nim_options)){
                                                    foreach($nim_options as $option){
                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                    $selected = $this->set_field_selected('nim',$value, "");
                                                    ?>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="id_pinjam">NIM <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-id_pinjam" name="id_pinjam"  placeholder="Select a value ..."    class="selectize" >
                                                    <option value="">Select a value ...</option>
                                                    <?php 
                                                    $id_pinjam_options = $comp_model -> pengembalian_id_pinjam_option_list();
                                                    if(!empty($id_pinjam_options)){
                                                    foreach($id_pinjam_options as $option){
                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                    $selected = $this->set_field_selected('id_pinjam',$value, "");
                                                    ?>
                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                        <?php echo $label; ?>
                                                    </option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="id_ptgs">Petugas <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-id_ptgs" name="id_ptgs"  placeholder="Select a value ..."    class="custom-select" >
                                                        <option value="">Select a value ...</option>
                                                        <?php 
                                                        $id_ptgs_options = $comp_model -> pengembalian_id_ptgs_option_list();
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-id_status" name="id_status"  placeholder="Select a value ..."    class="custom-select" >
                                                        <option value="">Select a value ...</option>
                                                        <?php 
                                                        $id_status_options = $comp_model -> pengembalian_id_status_option_list();
                                                ...
                                                <tr class="input-row">
                                                    <td>
                                                        <div id="ctrl-id_buku-row<?php echo $row; ?>-holder" class="">
                                                            <input id="ctrl-id_buku-row<?php echo $row; ?>"  value="<?php  echo $this->set_field_value('id_buku',"", $row); ?>" type="text" placeholder="Enter Id Buku" list="id_buku_list"  required="" name="detail_k[row<?php echo $row ?>][id_buku]"  class="form-control " />
                                                        ...
                                                        <td>
                                                            <div id="ctrl-jum_kembali-row<?php echo $row; ?>-holder" class="">
                                                                <input id="ctrl-jum_kembali-row<?php echo $row; ?>"  value="<?php  echo $this->set_field_value('jum_kembali',"", $row); ?>" type="number" placeholder="Enter Jum Kembali" step="1"  required="" name="detail_k[row<?php echo $row ?>][jum_kembali]"  class="form-control " />
                                                                </div>
                                                            </td>
