                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-id_pinjam">
                                        ...
                                        <td class="value">
                                            <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("peminjaman/view/" . urlencode($data['id_pinjam'])) ?>">
                                                <i class="fa fa-eye"></i> <?php echo $data['peminjaman_nim'] ?>
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="p-3 d-flex">
                            <div class="dropup export-btn-holder mx-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="btn btn-sm btn-info"  href="<?php print_link("pengembalian/edit/$rec_id"); ?>">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("pengembalian/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
