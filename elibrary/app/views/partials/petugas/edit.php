                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nama_ptgs"  value="<?php  echo $data['nama_ptgs']; ?>" type="text" placeholder="Tambahkan Nama Petugas"  required="" name="nama_ptgs"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-jabatan"  value="<?php  echo $data['jabatan']; ?>" type="text" placeholder="Tambahkan Jabatan"  required="" name="jabatan"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
